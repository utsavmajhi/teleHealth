...
let saveDataToPostGresDB = async(body,uid) => {
    ...
    return await db.tx(t => {
        let queries = []
        queries.push(t.one('INSERT INTO SUPERVISOR(supervisor_id, first_name, last_name, email, phone_number, active, created_at, updated_at) VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING supervisor_id', [
            uid,
            body.firstName,
            body.lastName,
            body.email,
...
let updateDataInPostGresDB = async(body,uid) => {
    ...
    return await db.tx(t => {
        let queries = []
        queries.push(t.none('UPDATE SUPERVISOR SET first_name = $1, last_name = $2, email = $3, phone_number = $4, active = $5, updated_at = $6 WHERE supervisor_id = $7', [
            body.firstName,
            body.lastName,
            body.email,
            body.phone,
...
exports.handler = async(event) => {
    ...
    try {
        ...
        if(body.type === 'create'){
            const cognitoParams = {
                UserPoolId: process.env.SUPERVISORPOOLID,
                Username: body.email,
        ...
        res = {
            ...
            body: JSON.stringify({ message: body.type ==="create"?"Supervisor User Creation Successful":"Supervisor User Updation Successful" })
        };
        return res;
    } catch (e) {
        console.log(e);
